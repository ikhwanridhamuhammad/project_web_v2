<?php 
  ...
  //================================================================================
  //================================================================================
  $_ex_sen_outlet             = array(1000);
  $_ex_sen_outlet_counter     = 0;
  $_ex_sen_enable_sensor      = 1;
  $_ex_sen_query_outlet     = "SELECT * FROM building WHERE building.enable_sensor = 1 ";
  ...
  //=================================================================== 
  //=================================================================== 
  $__ex_sen_query = " SELECT * FROM building WHERE building.name = '$_ses_ex_sen_outlet' ";
