...
<?php 
  ...
  //==================================================================================================================
    ...
    $_deta_shift_in_p         = array(300);     $_deta_shift_out_p        = array(300);   
    $_deta_shift_telat        = array(300);
  ...
  //==================================================================================================================
    ...
    while ($____dash_data = mysqli_fetch_array($result_outlet)){
      ...
      while ($____dash_data_ok = mysqli_fetch_array($result_karyawan)){
        ...
        $_deta_shift_in_p[$_deta_coounter]            = $____dash_data_ok['time_in_p'];
        $_deta_shift_out_p[$_deta_coounter]           = $____dash_data_ok['time_out_p'];
        $_deta_shift_telat[$_deta_coounter] = 0;
        if($_deta_shift_in_p[$_deta_coounter] > $_deta_shift_in[$_deta_coounter]){$_deta_shift_telat[$_deta_coounter] = 1;}
