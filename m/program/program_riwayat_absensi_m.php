<?php 
  ...
  include_once './program/date_time.php';
	...
	$_ra_tanggal_mundur_45_1 = date_create($tanggal_update_today);
	date_sub($_ra_tanggal_mundur_45_1,date_interval_create_from_date_string("45 days"));
	$_ra_tanggal_mundur_45 = date_format($_ra_tanggal_mundur_45_1,"Y-m-d");

	// $_ra_tanggal_start_default = $_ra_bulan."-01";
	$_ra_tanggal_start_default = $_ra_tanggal_mundur_45;
	...
	while ($__ra_data_karyawan = mysqli_fetch_array($__ra_result_karyawan)){
		...
		$__ra_tanggal_3[$__ra_counter]			= date_format(date_create($__ra_data_karyawan['presence_date']),"j F Y");
