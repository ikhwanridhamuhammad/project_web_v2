...
<?php
  ...
  if($_global_page_program == 12){include_once './chart_js/chart_table_extension_sensor.php';}
...
<?php 
  ...
  if($_global_page_program == 11){include_once './aksi/shift_smart_nitro.php';}
  if($_global_page_program == 12){include_once './aksi/extension_sensor.php';}
